...
//
// Supported channels: gemini-cli, vertex, aistudio, antigravity, claude, codex, qwen, iflow, kiro, github-copilot, trae.
func OAuthModelAliasChannel(provider, authKind string) string {
	...
	case "codex":
		...
		return "codex"
	case "gemini-cli", "aistudio", "antigravity", "qwen", "iflow", "kiro", "github-copilot", "trae":
		return provider
	default:
		return ""
	}
