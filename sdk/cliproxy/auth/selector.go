...
func (s *SessionAffinitySelector) Pick(ctx context.Context, provider, model string, opts cliproxyexecutor.Options, auths []*Auth) (*Auth, error) {
	...
	// Preserve the legacy weighted-robin prefilter; otherwise trust the manager's
	// credential-aware validation. Affinity membership spans every priority tier,
	// while fallback selection below remains scoped to the highest available tier.
	var available []*Auth
	var err error
	if authCandidatesPrefiltered(opts) {
