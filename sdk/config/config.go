...
type FreebuffModel = internalconfig.FreebuffModel
type DevinKey = internalconfig.DevinKey
type DevinModel = internalconfig.DevinModel
type MistralKey = internalconfig.MistralKey
type MistralModel = internalconfig.MistralModel
type OpenCodeKey = internalconfig.OpenCodeKey
type OpenCodeModel = internalconfig.OpenCodeModel
type MimocodeKey = internalconfig.MimocodeKey
type MimocodeModel = internalconfig.MimocodeModel
