...
var zhStrings = map[string]string{
	...
	"detailed_api_error_body_log_format": "详细 API 错误正文日志格式",
	"retry_count":                        "重试次数",
	"proxy_url":                          "代理 URL",
	"upstream_base_url":                  "上游基础地址（base_url）",
...
var enStrings = map[string]string{
	...
	"detailed_api_error_body_log_format": "Detailed API Error Body Log Format",
	"retry_count":                        "Retry Count",
	"proxy_url":                          "Proxy URL",
	"upstream_base_url":                  "Upstream Base URL (base_url)",
