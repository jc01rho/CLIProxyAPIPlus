...
const (
	defaultManagementReleaseURL  = "https://api.github.com/repos/jc01rho/Cli-Proxy-API-Management-Center/releases/latest"
	defaultManagementFallbackURL = "https://github.com/jc01rho/Cli-Proxy-API-Management-Center/releases/latest/download/management.html"
