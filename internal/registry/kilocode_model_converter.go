...
func GetKilocodeModels() []*ModelInfo {
	now := int64(1737024000) // 2025-01-16
	return []*ModelInfo{
		{
			ID:                  "kilocode-grok-code-fast-1",
			Object:              "model",
			Created:             now,
			OwnedBy:             "kilocode",
			Type:                "kilocode",
			DisplayName:         "Kilocode Grok Code Fast 1",
			Description:         "Grok Code Fast 1 (xAI, free for limited time)",
		...
		},
		{
			...
			OwnedBy:             "kilocode",
			Type:                "kilocode",
			DisplayName:         "Kilocode GLM 4.7",
			Description:         "GLM 4.7 (Z.AI, fast and open source)",
			ContextLength:       128000,
			MaxCompletionTokens: DefaultKilocodeMaxCompletionTokens,
			Thinking:            cloneThinkingSupport(DefaultKilocodeThinkingSupport),
		},
		{
			...
			OwnedBy:             "kilocode",
			Type:                "kilocode",
			DisplayName:         "Kilocode Qwen3 Coder",
			Description:         "Qwen3 Coder (optimized for agentic coding)",
			ContextLength:       128000,
			MaxCompletionTokens: DefaultKilocodeMaxCompletionTokens,
			Thinking:            cloneThinkingSupport(DefaultKilocodeThinkingSupport),
		},
		{
			ID:                  "kilocode-glm-4-5-air",
			Object:              "model",
			Created:             now,
			OwnedBy:             "kilocode",
			Type:                "kilocode",
			DisplayName:         "Kilocode GLM 4.5 Air",
			Description:         "GLM 4.5 Air (lightweight agent model)",
			ContextLength:       128000,
			MaxCompletionTokens: DefaultKilocodeMaxCompletionTokens,
			Thinking:            cloneThinkingSupport(DefaultKilocodeThinkingSupport),
		},
		{
			ID:                  "kilocode-deepseek-r1-0528",
			Object:              "model",
			Created:             now,
			OwnedBy:             "kilocode",
			Type:                "kilocode",
			DisplayName:         "Kilocode DeepSeek R1 0528",
			Description:         "DeepSeek R1 0528 (open reasoning)",
			ContextLength:       128000,
			MaxCompletionTokens: DefaultKilocodeMaxCompletionTokens,
			Thinking:            cloneThinkingSupport(DefaultKilocodeThinkingSupport),
		},
		{
			...
			OwnedBy:             "kilocode",
			Type:                "kilocode",
			DisplayName:         "Kilocode Kimi K2",
			Description:         "Kimi K2 (MoonshotAI, advanced tool use)",
			ContextLength:       200000,
			MaxCompletionTokens: DefaultKilocodeMaxCompletionTokens,
			Thinking:            cloneThinkingSupport(DefaultKilocodeThinkingSupport),
		},
		{
			ID:                  "kilocode-minimax-m2-1",
			Object:              "model",
			Created:             now,
			OwnedBy:             "kilocode",
			Type:                "kilocode",
			DisplayName:         "Kilocode MiniMax M2.1",
			Description:         "MiniMax M2.1 (free for Code Reviewer)",
			ContextLength:       128000,
			MaxCompletionTokens: DefaultKilocodeMaxCompletionTokens,
			Thinking:            cloneThinkingSupport(DefaultKilocodeThinkingSupport),
		},
