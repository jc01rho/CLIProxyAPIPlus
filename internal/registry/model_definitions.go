...
// GetAmpCodeModels returns the AmpCode model definitions.
// AmpCode uses frontier models for agentic coding.
func GetAmpCodeModels() []*ModelInfo {
	return []*ModelInfo{
		{
			ID:                  "claude-opus-4.5",
			Object:              "model",
			...
			Type:                "ampcode",
			DisplayName:         "Claude Opus 4.5",
			Description:         "Smart mode - unconstrained state-of-the-art model use",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
			Thinking:            &ThinkingSupport{Min: 1024, Max: 128000, ZeroAllowed: true, DynamicAllowed: false},
		},
		{
			...
			Type:                "ampcode",
			DisplayName:         "Claude Haiku 4.5",
			Description:         "Rush mode - faster and cheaper for small, well-defined tasks",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
			// Thinking: not supported for Haiku models
		},
		{
			ID:                  "gpt-5.2",
			Object:              "model",
			Created:             1760000000, // Approximate
			OwnedBy:             "openai",
			Type:                "ampcode",
			DisplayName:         "GPT-5.2",
			Description:         "Oracle agent - complex reasoning & planning on code",
			ContextLength:       200000,
			MaxCompletionTokens: 64000,
			Thinking:            &ThinkingSupport{Min: 1024, Max: 128000, ZeroAllowed: true, DynamicAllowed: false},
		},
