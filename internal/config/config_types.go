...
func (k MistralKey) GetPrefix() string   { return k.Prefix }
func (k MistralKey) GetProxyURL() string { return k.ProxyURL }

// MistralModel maps a client alias to an upstream model name.
