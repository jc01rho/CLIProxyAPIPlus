...
type SDKConfig struct {
	...
	// APIKeyModelWhitelists optionally restricts models available to individual API keys.
	// Keys absent from the map, or entries with no patterns, can use every model.
	APIKeyModelWhitelists map[string][]string `yaml:"api-key-model-whitelists,omitempty" json:"api-key-model-whitelists,omitempty"`
