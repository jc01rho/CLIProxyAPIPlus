...
// name contains "free", "composer", "grok", "opus", "sonnet", "kimi-k3",
// "fable", "mythos", or "haiku".
func FilterCursorModels(models []*registry.ModelInfo) []*registry.ModelInfo {
	return filterModelsContaining(models, "free", "composer", "grok", "opus", "sonnet", "kimi-k3", "fable", "mythos", "haiku")
}
